 ...
 */
#define RHR 0	// Receive Holding Register (read mode),接收保持寄存器
#define THR 0	// Transmit Holding Register (write mode)，发送保持寄存器
#define DLL 0	// LSB of Divisor Latch (write mode)，分频器锁存器的最低有效位
#define IER 1	// Interrupt Enable Register (write mode)，中断使能寄存器
#define DLM 1	// MSB of Divisor Latch (write mode)，分频器锁存器的最高有效位
...
#define SPR 7	// ScratchPad Register，暂存器
